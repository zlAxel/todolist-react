function App() {
  return (
    <>
		<section class="antialiased bg-slate-200 text-slate-700 h-screen flex justify-center items-center">
			<div class="max-w-xl mx-auto bg-white p-8 rounded-xl shadow shadow-slate-300 w-full">
